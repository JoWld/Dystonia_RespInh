...
% HISTORY
% 04/13/21 JW created based on SR Research Pursuit Demo available with
% Psychtoolbox
%
...
try
    ...
    % send start of experiment msg to EEG
    ...
    for i = 1 : numTrials
        ...
        while GetSecs < trialTime
            ...
            % Sending a message to mark the start of a trial in EEG data
            if outp_switch == 1
